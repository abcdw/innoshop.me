...
def admin_todo_list(request):
    ...
    return render(request, 'admin/todo_list.html', context)
...
def admin_todo_list_print(request):
    ...
    return render(request, 'admin/todo_list_print.html', context)
...
def admin_view_order(request):
    ...
    return render(request, 'admin/r_view_order.html', context)
...
def view_order(request):
    try:
        ...
        return render(request, 'r_view_order.html', context)
    except Exception, e:
